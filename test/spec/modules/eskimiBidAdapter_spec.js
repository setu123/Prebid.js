...
describe('Eskimi bid adapter', function () {
  describe('isBidRequestValid', function () {
    it('should accept request if placementId and siteId are passed', function () {
      let bid = {
        bidder: 'eskimi',
        params: {
          placementId: 1003000,
    ...
    it('should not accept request if only siteId is passed', function () {
      let bid = {
        bidder: 'eskimi',
        params: {
          siteId: 3,
  ...
  describe('buildRequests', function () {
    it('creates request data', function () {
      ...
      expect(payload.imp[0]).to.have.property('id', REQUEST.bidRequest[0].adUnitCode);
      expect(payload.imp[1]).to.have.property('id', REQUEST.bidRequest[1].adUnitCode);
    });
